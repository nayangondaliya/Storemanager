...
namespace Raditap.DatabaseAccess.Specifications
{
    /// <summary>
    ...
    public abstract class BaseSpecification<T> : ISpecification<T>
    {
        ...
        public bool IsReadUncommitted { get; private set; } = false;

        //protected virtual void ApplyReadUncommitted()
        //{
        //    IsReadUncommitted = true;
        //}
